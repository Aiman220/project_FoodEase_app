    ...
    return(
        ...
        <section className="flex flex-wrap justify-center lg:justify-between items-center gap-3 p-3 py-5 lg:py-0 lg:px-10">
            ...
            <div className="flex flex-col items-start gap-y-5">
                ...
                <h1 className="font text-xl font-bold">FoodEase One</h1>
                <p className="text-[0.9rem] sm:text-xm fonts text-gray-700">Get free delivery and extra discounts all across FoodEase.</p>
                <p className="text-[0.9rem] sm:text-xm fonts text-gray-700">Your FoodEase One benefits can be availed only on the FoodEase App.</p>
