        ...
        <section className="bg-red-100 p-8 md:p-16 select-none">
            ...
            <div className="flex flex-wrap  lg:justify-center items-start gap-8 md:gap-16">
                ...
                <div className="flex flex-col gap-y-3 ">
                    ...
                    <p className="fonts">Phone: +91 5827-87524</p>
                    <p className="fonts">Email: FoodEasefoods4@gmail.com</p>
            ...
            <div className="flex flex-col md:flex-row gap-7 justify-between lg:px-20 items-start pt-10">
                 <p className="fonts text-[0.8rem] text-[#fc036f] ">Copyright - 2023 website made by Aiman. All Rights Reserved.</p>

                 <div className="flex flex-row gap-x-4 justify-center items-center">
                    <h1 className="fonts">Follow</h1>
                    <h1 className="text-[#fc036f] text-xl rounded-full drop-shadow-lg"><BsFacebook/></h1>
                    <Link to="https://github.com/"><h1 className="text-[#fc036f] text-xl rounded-full drop-shadow-lg"><BsGithub/></h1></Link>
                    <Link to="https://www.youtube.com/"><h1 className="text-[#fc036f] text-xl rounded-full drop-shadow-lg"><BsYoutube/></h1></Link>
                    <Link to="https://www.linkedin.com/"><h1 className="text-[#fc036f] text-xl rounded-full drop-shadow-lg"><BsLinkedin/></h1></Link>
                 </div>
            </div>
